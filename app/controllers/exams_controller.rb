...
class ExamsController < ApplicationController # :nodoc:
  before_action :set_exam, only: %i[show edit update destroy]
  before_action :redirect_default_user, except: %i[show index]
  ...
  def exam_params
    params.require(:exam).permit(:title, questions_attributes: %i[id type text score is_scorable _destroy])
  end
end
